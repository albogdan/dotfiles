...
external_url 'http://gitlab.andromeda.lan'
...
gitlab_rails['trusted_proxies'] = ["192.168.1.3"]
...
# nginx['ssl_certificate'] = "/etc/httpscert/192.168.1.3.crt"
# nginx['ssl_certificate_key'] = "/etc/httpscert/192.168.1.3.key"
